...
function onTypeChange(){
  const isMalattia = $("#event_type").value === "Malattia";
  const field = $("#cert-field");
  const input = $("#medical_cert_number");
  field.style.display = isMalattia ? "block" : "none";
  input.required = isMalattia;
  if(!isMalattia) input.value = "";
}
